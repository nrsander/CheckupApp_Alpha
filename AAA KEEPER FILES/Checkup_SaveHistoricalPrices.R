...
SavePricesToStorage <- function(myHistoricalPricesList=HistoOHLCV(timeframe="minute",pd=1000),myDirectory="LocalStorage/Prices/") {
  ...
  if (myHistoricalPricesList == "oopsError") {return("oopsError")}

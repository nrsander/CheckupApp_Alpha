...
##################################################################################################################################
# This coin section isn't used, but try coin data instead of stock data here in the future.
##################################################################################################################################
## Create test sets
#coins_daily <- HistoOHLCV(InputCoinSet=c("BTC","ETH","BCH","XMR","NEO"),timeframe="day",pd=3*365) # 3 years 
#coins_hourly <- HistoOHLCV(InputCoinSet=c("BTC","ETH","BCH","XMR","NEO"),timeframe="hour",pd=2.5*31*24) # 2.5 months
#coins_minutely <- HistoOHLCV(InputCoinSet=c("BTC","ETH","BCH","XMR","NEO"),timeframe="minute",pd=1.3*24*60) # 1 day, 8 hrs
##################################################################################################################################
#coins_daily
#coins_hourly
#coins_minutely
